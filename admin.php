...
$string['accessdenied'] = 'އެކްސެސް މަނާކުރެވިފައި';
$string['accounts'] = 'އެކައުންޓްތައް';
$string['addcategory'] = 'އައު ކެޓަގަރީއެއް އިތުރުކުރުމަށް';
$string['additionalhtml'] = 'HTML އިތުރ';
$string['additionalhtml_heading'] = 'HTML ކޮންމެ ސަފްޙާއަކަށް އިތުރު ކުރެވޭ';
